...
| **L8** | Canvas blob не union-AABB через notch (або свідомо задокументувати відхід від G5–G7) | P1 | ✅ documented skip |
