...
- [ ] P0 C2/L1/L2/L3/L4/C3/L9 зелені (unit + failure).
- [ ] T3/T4: Variant B і magnet тести падають на зіпсованому paint, не на мертвому WASM.
- [ ] T1/T2 тести здатні падати.
- [ ] Scorecard у [CRITIQUE-dg_9352d52.md](../tech-debt/CRITIQUE-dg_9352d52.md) оновлено.
