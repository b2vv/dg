...
36. 🔴 **Виправлення, дописане новою секцією, не виправляє перелік — а виконують перелік.**
    ...
    **саме тому, що детальний** — і його не перечитують. Реалізатор бере рядок таблиці, а не
    абзац під нею.
    **Практичне:** після будь-якої правки рішення — `grep` по **старій** назві / старому
    твердженню в тому самому файлі, і лише тоді коміт. Якщо стара назва лишилась деінде, крім
    речення, що пояснює зміну, — правка не завершена.
