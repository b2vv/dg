...
**Дата:** 2026-09-08
**Базис:** `main` @ `6b199a4` (після T115 кроків 1–3; попередній базис `fbb817b` відстав на 22 коміти)
