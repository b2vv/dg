...
**Дата:** 2026-09-05
**Базис:** `main` @ `9f0c7f3` (після T104, T103, T108)
...
9. **T101 / T105 / T106 / T109** — агент-реді, нічого не блокує. ⚠️ **T101 більше не та задача, що написана:** його гіпотеза («винні паралельні воркери») **спростована 2026-09-04** — падає 2 з 3 при `--workers=1`. T105 вище порога пайплайна (публічний API) — `spec-flow`. T103/T104/T108 закриті.
