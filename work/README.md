...
47. [T47-magnet-radius-canonical.md](./tasks/T47-magnet-radius-canonical.md) — ⚠️ radius 2 still forced C; superseded by T48
48. [T48-adjacency-magnetism.md](./tasks/T48-adjacency-magnetism.md) — ✅ magnetRadius 1.5: top row + two bottom blobs
