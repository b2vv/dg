...
| **M1** | Око: SVG проти екрана | таб «Staff · Flood» | експортувати SVG і відкрити поруч із канвасом | контури в файлі стоять там само, що й на екрані | **вручну** ✅ 2026-08-26 — збіглося; окремо виявлено, що SVG не успадковує тему |
