...
Тобто хост **уже** спроєктував заміну рушія й записав її контракт: **21 член інтерфейсу + 8 типів
...
## Відображення 21 члена — попереднє
...
1. **Найдешевша перевірка паритету — не 51 рядок, а ці 21 + 8.** Контракт скінченний і
