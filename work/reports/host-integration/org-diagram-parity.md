...
| 21 | Матриця схлопнутих сиблінгів (`matrixOnCollapse`, >1 дітей, «хребет» trunk/bus/riser) | Уже під розбором — [`T113`](../../archive/tasks-2026-09-11.md), разом із несумісністю з оголошеними контейнерами | **див. T113** |
