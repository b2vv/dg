...
`OrgHierarchyError`, дані не змінені). Це навмисна політика, а не заглушка: там, де редагують
масово й мають undo, «зробити й дати відкотити» зручніше за модалку на кожному перетягу.
